...
// TM config
#define I_REUSABLE_TMS          FALSE       // Always makes vanilla TMs reusable. Emerald also supports the optional Reusable TMs run rule when FALSE; individual TMs can set importance to 1.
