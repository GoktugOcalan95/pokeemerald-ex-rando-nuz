...
// Bag constants
#define BAG_SAVE1_SLOTS 256
#define BAG_SAVE1_BYTES (BAG_SAVE1_SLOTS * 5 / 2)
#define BAG_SAVE3_BYTES (((ITEMS_COUNT - BAG_SAVE1_SLOTS) * 5 + 1) / 2)
...
#define OPTIONS_TEXT_SPEED_AUTO 4
