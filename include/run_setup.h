...
enum RunSetupCategory
{
    ...
    RUN_SETUP_CATEGORY_GIMMICK_BANS,
...
enum RunSetupSetting
{
    ...
    RUN_SETUP_NO_BATTLE_ITEMS,
    RUN_SETUP_NO_EV_GAIN,
    RUN_SETUP_FULL_COMPATIBILITY,
    RUN_SETUP_REUSABLE_TMS,
    RUN_SETUP_EXPANDED_TMS,
    RUN_SETUP_ITEMS,
    RUN_SETUP_BAN_SLATEPORT,
    RUN_SETUP_BAN_BATTLE_ITEMS,
    RUN_SETUP_LIMIT_SLATEPORT_SHOP,
    RUN_SETUP_BAN_MEGA_STONES,
    RUN_SETUP_BAN_Z_CRYSTALS,
    RUN_SETUP_BAN_TERA_SHARDS,
    RUN_SETUP_BAN_TYPE_GEMS,
