...
{
    [RUN_SETUP_PRESET_VANILLA] = {FALSE, FALSE, FALSE, FALSE, FALSE, FALSE},
    [RUN_SETUP_PRESET_NUZLOCKE] = {TRUE, TRUE, FALSE, FALSE, FALSE, FALSE},
    [RUN_SETUP_PRESET_BISHEY] = {TRUE, TRUE, FALSE, FALSE, FALSE, FALSE},
};
