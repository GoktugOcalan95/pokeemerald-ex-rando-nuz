...
static const u8 sLabel_LIMIT_SLATEPORT_SHOP[] = _("Limit Slateport shop");
...
const struct RunSetupSettingInfo gRunSetupSettings[RUN_SETUP_SETTING_COUNT] =
{
    ...
    [RUN_SETUP_LIMIT_SLATEPORT_SHOP] = {sLabel_LIMIT_SLATEPORT_SHOP, sHelp_LIMIT_SLATEPORT_SHOP, sBooleanChoices, FLAG_RUN_RULE_LIMIT_SLATEPORT_SHOP, RUN_SETUP_CATEGORY_ITEMS, ARRAY_COUNT(sBooleanChoices), RUN_SETUP_DEPENDENCY_NONE, {0, 0, 1}},
