...
static const u8 sHelp_ABILITIES[] = _("Randomize abilities of Pokémon.");
static const u8 sLabel_ITEMS[] = _("Randomize items");
static const u8 sHelp_ITEMS[] = _("Randomize non-key items.");
...
static const u8 sLabel_LIMIT_SLATEPORT_SHOP[] = _("Limit Slateport shops");
static const u8 sHelp_LIMIT_SLATEPORT_SHOP[] = _("Mega/Z/Tera items, gems and mints\nsold only after becoming Champion.");
static const u8 sLabel_BAN_MEGA_STONES[] = _("Ban Mega Stones");
static const u8 sHelp_BAN_MEGA_STONES[] = _("Exclude Mega Stones from\nrandomized item pools.");
static const u8 sLabel_BAN_Z_CRYSTALS[] = _("Ban Z-Crystals");
static const u8 sHelp_BAN_Z_CRYSTALS[] = _("Exclude Z-Crystals from\nrandomized item pools.");
static const u8 sLabel_BAN_TERA_SHARDS[] = _("Ban Tera Shards");
static const u8 sHelp_BAN_TERA_SHARDS[] = _("Exclude Tera Shards from\nrandomized item pools.");
static const u8 sLabel_BAN_TYPE_GEMS[] = _("Ban type gems");
static const u8 sHelp_BAN_TYPE_GEMS[] = _("Exclude single-use type-boosting\ngems from randomized item pools.");
...
static const u8 sLabel_GOOD_MOVE_CHANCE[] = _("Good attack chance");
...
static const u8 sHelp_DIFFICULTY[] = _("Set trainer levels, IVs, AI, and\nrandomized team difficulty.");
...
static const u8 sHelp_NO_EV_GAIN[] = _("Keep all Pokemon EVs at zero.\nHide EV items in shops/rewards.");
...
static const u8 sHelp_SETUP_MOVE_PP[] = _("Limit select OP setup moves\nto 1 PP. Applies to both sides.");
...
static const u8 sHelp_NO_BATTLE_ITEMS[] = _("No in-battle bag items for player and AI;\nLike potions, or X-items.");
static const u8 sLabel_EXPANDED_TMS[] = _("Expanded TM list");
static const u8 sHelp_EXPANDED_TMS[] = _("Adds TM51-100 to rewards and shops.");
...
static const u8 sHelp_EARLY_SURF[] = _("Swap Surf and Strength.\nUse it after defeating Wattson.");
...
static const u8 sHelp_AUTO_HEAL[] = _("Heal alive party members after battle.\nRestores PP, status, Tera charge.");
...
static const u8 sCatchHelpNone[] = _("Normal catch chance.");
static const u8 sCatchHelpLow[] = _("1.5x catch chance.");
static const u8 sCatchHelpMedium[] = _("3x catch chance.");
static const u8 sCatchHelpHigh[] = _("5x catch chance.");
static const u8 sCatchHelpInstant[] = _("Instantly catch every time.");
static const u8 *const sCatchHelp[] = {sCatchHelpNone, sCatchHelpLow, sCatchHelpMedium, sCatchHelpHigh, sCatchHelpInstant};

static const u8 sDifficultyHelpNormal[] = _("Vanilla Emerald trainer experience.");
static const u8 sDifficultyHelpHard[] = _("Gym leaders and rival fights are harder.");
static const u8 sDifficultyHelpUnfair[] = _("All trainers are harder, especially gym\nleaders and rival fights.");
static const u8 *const sDifficultyHelp[] = {sDifficultyHelpNormal, sDifficultyHelpHard, sDifficultyHelpUnfair};
static const u8 sGoodHelp0[] = _("Pick randomly from eligible moves.\nNo extra chance given to good attacks.");
...
const struct RunSetupSettingInfo gRunSetupSettings[RUN_SETUP_SETTING_COUNT] =
{
    ...
    [RUN_SETUP_GOOD_MOVE_CHANCE] = {sLabel_GOOD_MOVE_CHANCE, sHelp_GOOD_MOVE_CHANCE, sChanceChoices, VAR_RUN_RULE_GOOD_MOVE_CHANCE, RUN_SETUP_CATEGORY_MOVES, ARRAY_COUNT(sChanceChoices), RUN_SETUP_DEPENDENCY_MOVES, {0, 0, 0}, sGoodHelp},
    ...
    [RUN_SETUP_NO_BATTLE_ITEMS] = {sLabel_NO_BATTLE_ITEMS, sHelp_NO_BATTLE_ITEMS, sBooleanChoices, FLAG_RUN_RULE_NO_BATTLE_ITEMS, RUN_SETUP_CATEGORY_BATTLE, ARRAY_COUNT(sBooleanChoices), RUN_SETUP_DEPENDENCY_NONE, {0, 0, 1}},
    ...
    [RUN_SETUP_EXPANDED_TMS] = {sLabel_EXPANDED_TMS, sHelp_EXPANDED_TMS, sBooleanChoices, FLAG_RUN_RULE_EXPANDED_TMS, RUN_SETUP_CATEGORY_TRAINING, ARRAY_COUNT(sBooleanChoices), RUN_SETUP_DEPENDENCY_NONE, {0, 0, 1}},
    ...
    [RUN_SETUP_LIMIT_SLATEPORT_SHOP] = {sLabel_LIMIT_SLATEPORT_SHOP, sHelp_LIMIT_SLATEPORT_SHOP, sBooleanChoices, FLAG_RUN_RULE_LIMIT_SLATEPORT_SHOP, RUN_SETUP_CATEGORY_ITEMS, ARRAY_COUNT(sBooleanChoices), RUN_SETUP_DEPENDENCY_NONE, {0, 1, 1}},
    [RUN_SETUP_BAN_MEGA_STONES] = {sLabel_BAN_MEGA_STONES, sHelp_BAN_MEGA_STONES, sBooleanChoices, FLAG_RUN_RULE_BAN_MEGA_STONES, RUN_SETUP_CATEGORY_GIMMICK_BANS, ARRAY_COUNT(sBooleanChoices), RUN_SETUP_DEPENDENCY_ITEMS, {0, 0, 0}},
    [RUN_SETUP_BAN_Z_CRYSTALS] = {sLabel_BAN_Z_CRYSTALS, sHelp_BAN_Z_CRYSTALS, sBooleanChoices, FLAG_RUN_RULE_BAN_Z_CRYSTALS, RUN_SETUP_CATEGORY_GIMMICK_BANS, ARRAY_COUNT(sBooleanChoices), RUN_SETUP_DEPENDENCY_ITEMS, {0, 0, 1}},
    [RUN_SETUP_BAN_TERA_SHARDS] = {sLabel_BAN_TERA_SHARDS, sHelp_BAN_TERA_SHARDS, sBooleanChoices, FLAG_RUN_RULE_BAN_TERA_SHARDS, RUN_SETUP_CATEGORY_GIMMICK_BANS, ARRAY_COUNT(sBooleanChoices), RUN_SETUP_DEPENDENCY_ITEMS, {0, 0, 0}},
    [RUN_SETUP_BAN_TYPE_GEMS] = {sLabel_BAN_TYPE_GEMS, sHelp_BAN_TYPE_GEMS, sBooleanChoices, FLAG_RUN_RULE_BAN_TYPE_GEMS, RUN_SETUP_CATEGORY_GIMMICK_BANS, ARRAY_COUNT(sBooleanChoices), RUN_SETUP_DEPENDENCY_ITEMS, {0, 0, 1}},
